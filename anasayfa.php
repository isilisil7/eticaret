...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <!-- menubardan sonra gelen öğeler menubarın altında kaldığı için
    menubardan sonra boşluk bırakma işlemi aşağıda gerçekleştirildi. -->
    <div class="bosluk">
        &nbsp;
    </div>
...
<!-- slideshow için html kodları bitimi -->
        ...
        <div class="kategoriButonu">
          <a href="kategoriler.php"><button>Kategoriler</button></a>
        </div>
